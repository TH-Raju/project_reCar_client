...
const Review = () => {
    return (
        <div className='mb-60'>
            ...
            <div className="flex shadow-slate-500 shadow-lg border border-x-slate-600 border-t-slate-600 flex-col  lg:w-2/4 md:w-5/6  p-6 mx-auto divide-y rounded-md divide-gray-700 text-black">
                <div className="flex justify-between p-4">
                    <div className="flex space-x-4">
                        <div>
                            <img src="https://source.unsplash.com/100x100/?portrait" alt="" className="object-cover w-12 h-12 rounded-full dark:bg-gray-600" />
                        </div>
                        <div>
            ...
            <div className="flex flex-col  shadow-slate-500 shadow-lg border border-x-slate-600 border-t-slate-600 my-8 lg:w-2/4 md:w-5/6  p-6 mx-auto divide-y rounded-md divide-gray-700 text-black">
                <div className="flex justify-between p-4">
                    <div className="flex space-x-4">
                        <div>
