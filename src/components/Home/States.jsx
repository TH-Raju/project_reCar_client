    ...
    return (
        <div className='my-12 mb-48'>
            ...
            <section className="p-6 text-black">
                <div className=" w-5/6  justify-items-center grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6  text-black">
                    ...
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6  text-black">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 dark:text-white">
